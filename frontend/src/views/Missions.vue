...
<template>
  <div class="min-h-screen bg-[#eef2f6]">
    <header class="flex items-center justify-between border-b border-gray-200 bg-white px-8 py-4 print:hidden">
      <RouterLink to="/">
      ...
      <div class="flex items-center gap-4">
        ...
        <RouterLink to="/profil" class="flex items-center gap-3">
          <span
            class="flex h-9 w-9 items-center justify-center rounded-full bg-[#2f6fb0] text-sm font-semibold text-white"
          >
            {{ initials }}
          </span>
    ...
    <main class="px-10 py-8">
      <div class="flex items-center justify-between print:hidden">
        <button
          type="button"
          class="flex items-center gap-2 rounded-lg bg-gray-200 px-5 py-2 text-sm font-semibold text-gray-600 transition hover:bg-gray-300"
          @click="router.back()"
        >
        ...
        <div class="relative">
          <button
            type="button"
            class="flex items-center gap-2 rounded-lg border border-[#7cb342] bg-white px-5 py-2 text-sm font-semibold text-[#0d3b56] transition hover:bg-gray-50"
      ...
      <h1 class="mt-6 text-2xl font-extrabold text-[#0d3b56]">Missions comptable</h1>
      <p class="mt-1 text-sm text-gray-500">Liste complète des missions effectuées</p>

      <div class="relative mt-6 max-w-xl print:hidden">
        <svg
          viewBox="0 0 24 24"
      ...
      <div class="mt-6 overflow-hidden rounded-lg bg-white shadow-sm">
        <table class="w-full text-left text-sm">
          ...
          <tbody>
            <tr v-for="(mission, index) in filteredMissions" :key="index" class="border-t border-gray-100">
