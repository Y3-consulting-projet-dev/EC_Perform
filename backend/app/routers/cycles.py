...
from app.models.repartition import RepartitionUpdateRequest
...
def update_repartition(
    ...
    return repartition_service.update_repartition(mission_id, code, payload.risque, payload.assigneA, payload.delai)
